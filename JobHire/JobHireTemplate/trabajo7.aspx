		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-07.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Conduce con Uber y obtén ganancias rápidas</h3> <!--Aqui va el titulo del empleo-->
							<h5>UBER</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">>UBER</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">Por Horas</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>
                    ...
                    <br />
                                UBER es una empresa de tecnología cuya plataforma permite a los viajeros conectarse con el servicio de un conductor.<br />
                    <strong>CÓMO FUNCIONA:</strong> 
                         <br />
                                Maneja con Uber y recibe ganancias semanales prestando servicios independientes a la comunidad de usuarios para moverse por la ciudad. Conducir con Uber es una buena manera de generar tus propias ganancias administrando tu tiempo y siendo tu propio jefe. Cuanto más conduzcas, más podrás generar, eso depende de ti.
                         <br />
                         <br />
                    <strong>Para Inscribirte:</strong><br />
                    <a href="https://ubr.to/2JnRrgy">https://ubr.to/2JnRrgy</a> <br />

                               <strong>LO QUE NECESITAS SABER:</strong> 
                       <br />
 

                                Ganancias: Cuanto más conduzcas, más ganas.<br />
                                Administración de tu tiempo: Como socio de Uber, tú decides cómo administras tu tiempo, tanto de día como de noche. <br />
                                Registro: Es fácil y rápido.<br />
                                Ganancias semanales: El pago de tus ganancias serán enviadas a la cuenta bancaria que hayas registrado como prestador de servicios independientes y/o socio de Uber. Tus ganancias dependeràn totalmente de ti y de la forma en cómo decidas administrar tu propio tiempo.  <br />

                     <strong>LO QUE NECESITAS TENER:</strong> 
                       <br />
                                Tener un vehículo de 4 puertas modelo 2006 en adelante <br />
                                Tener permiso de conducir y un seguro vigentes <br />
                                Tener 21 años o más<br />
				</p>

                <!-- Hasta aqui colocar la informacion del trabajo -->
                <br /><br /> 
                <i>
                    <small>El contenido de este aviso es de propiedad del anunciante. Los requisitos de la posición son definidos y administrados por el anunciante sin que JobHire sea responsable por ello.</small>
                </i>
			</div>
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Cuidad de Panamá</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>Por Horas</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 5 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
