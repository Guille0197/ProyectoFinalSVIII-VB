		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-010.jpeg" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>SUPERVISOR - COCHEZ CORONADO</h3> <!--Aqui va el titulo del empleo-->
							<h5>Cochez y Cía</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">Cochez y Cía</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$1,000 - $1,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>  Cochez tiene actualmente más de 80 años en el mercado de los materiales de construcción, acabados y ferretería en Panamá. Nuestro pasado combinado a un futuro promisorio, nos hacen ser líderes en nuestro segmento.
 </p>

				
                    <p> Nos encontramos en la búsqueda de Supervisor de Sucursal con alto sentido de responsabilidad, honestidad y orientación al servicio que cumpla con los siguientes requisitos:
                    </p>
                <p>
                    ...
                    <br />
                    Graduado o cursando estudios en Administración o carrera similar.
                    <br />
                    Un (1) año de experiencia necesaria en Supervisión de personal.
                    <br />
                    Conocimiento y manejo de archivos, Contabilidad, Equipos de oficina.
                    <br />
                    Habilidad de expresión oral y escrita.
                    <br />
                    Residencia en Chame, San Carlos, Bejuco o áreas aledañas.
                    <br />
                    ...
                    Liderazgo y trabajo en equipo.
                        <br />
                    Buena habilidad para atender y tramitar simultáneamente varias actividades.
                        <br />
                    Adaptabilidad.
                        <br />
                    Habilidad para la redacción y síntesis.
                        <br />
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Coronado, Panamá</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>$1,000 - $1,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 18 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
