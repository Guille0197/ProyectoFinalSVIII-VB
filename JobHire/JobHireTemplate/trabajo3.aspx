		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-02.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>SECRETARIA RECEPCIONISTA</h3> <!--Aqui va el titulo del empleo-->
							<h5>CEMEX</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">CEMEX</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$800 - $2,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>Recibir todas las llamadas que entren a la Empresa y canalizarlas a quien corresponda, dando siempre una imagen profesional y atenta, así como realizar llamadas a larga distancia para quien lo solicita. Proporcionar apoyo en el proceso administrativo. </p>

				<p>
                    <strong>FUNCIONES  ESPECÍFICAS:</strong> 
                    <br />
                    
                   • Recibir a los visitantes   <br />
                    • Responder a las llamadas telefónicas
                    <br />
                  • Gestionar la distribución de la correspondencia interna y externa 
                    <br />
                    • Organizar reuniones
                    <br />
                    • Apoyo secretarial
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Panamá</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>$800 - $2,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
