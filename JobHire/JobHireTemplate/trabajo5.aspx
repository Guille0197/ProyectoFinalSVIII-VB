		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-04.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Gerente de Sucursal</h3> <!--Aqui va el titulo del empleo-->
							<h5>Scotiabank Panamá</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">Scotiabank Panamá</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$2,500 - $4,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>
                    <strong> Puntos importantes en la descripción de la vacante:</strong> 
                    <br />

                        1. Responsable por el cumplimiento de ventas, procesos operativos, administración de la sucursal y velar por el servicio al cliente.
                          <br />
                        2. Responsable por el desempeño del equipo de ventas de acuerdo a los objetivos establecidos por el negocio.
                          <br />
                        3. Asegurar el funcionamiento eficiente de la Sucursal.
                          <br />
                        4. Cumplir politicas, procedimientos de cumplimiento normativo para todos los productos/ servicios del banco.
                          <br />
                        5. Desarrollar al personal que tenga bajo su cargo promoviendo un entorno de alto desempeño.
                          <br />
                        6. Lidera y conduce una cultura centrada en el cliente para todo su equipo.
                          <br />
                        7. Crea un entorno donde su equipo realiza operaciones eficaces y eficientes en sus areas respectivas, a la vez que  garantiza la idoneidad, el cumplimiento y la eficacia de los controles de negocios diarios a fin de cumplir con las obligaciones destinadas a reducir los diferentes riesgos.
                          <br />
                        8. Manejo y administración efectiva de la segmentación de clientes.
                          <br />
                        9. Enfoque y seguimiento diario en el crecimiento de la cartera y rentabilidad positiva del portafolio de la sucursal.
				</p>
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Los Santos, Las Tablas</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>2,500 - $4,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 4 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
