		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-06.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Técnico en Redes</h3> <!--Aqui va el titulo del empleo-->
							<h5>Cable Onda</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">Cable Onda</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$800 - $1,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
...
<div class="container">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>
                    ...
                    <br />
                    1.     Bachiller en Eléctrica, Electrónica.
                       <br />
                    2.     Experiencia en uso de medidores de señal RF.
                       <br />
                    3.     Manejo ce escalera de extensión, trabajos en alturas.
                       <br />
                    4.     Licencia de Conducir Tipo D.
    ...
    <br />
                    ...
                    <strong>Funciones</strong>
                       <br />
                    1.     Atender los daños de planta externa asociados con afectaciones en la red HFC y Fibra Óptica.
                       <br />
                    2.     Coordinar con contratistas y su coordinador las reparaciones y mantenimientos a los elementos de la red.
                       <br />
                    3.     Auditar los trabajos del contratista y garantizar que fueron realizados según los estándares establecidos por la empresa.
                       <br />
                    4.     Realizar informes de situaciones detectadas en la red para tomar acciones preventivas y solicitar a su coordinador el mantenimiento programado o de emergencia.
                       <br />
                    5.     Enviar diariamente reportes a su coordinador de las tareas realizadas en la jornada de trabajo.
                       <br />
                    6.      Inspeccionar los proyectos nuevos y extensiones de red para garantizar preventivamente la alta disponibilidad de la red.
				</p>
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Herrera, Chitré</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>$800 - $1,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
