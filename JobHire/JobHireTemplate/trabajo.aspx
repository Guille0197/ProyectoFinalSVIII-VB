		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-01.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Analista Desarrollador Web</h3> <!--Aqui va el titulo del empleo-->
							<h5>Exceltec</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#"> Exceltec</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$1,500 - $2,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>Se requiere contratar un Ingeniero en Sistemas de Computación con mínimo 3 años de experiencia para desempeñarse como Analista Desarrollador Web.</p>

				<p>
                    <strong>Experiencia Requerida:</strong> 
                    <br />
                    * Experiencia laboral analizando, diseñando y desarrollando bajo plataforma Visual Studio con bases sólidas sobre tecnologías de UI (js, css, html) y middleware (webAPIs y web services) usando tecnologías .NET.
                    <br /> 
                    * Experiencia laboral desarrollando en lenguajes C#, VB.Net (Entornos Web), manejo de estándares y paradigmas de desarrollo indispensable: OOP, MVC, VC, MC.
                    Capacidad de abstraer, diseñar y desarrollar estructuras de datos. 
                    <br />
                    * Experiencia laboral desarrollando en Entorno de desarrollo Entity Framework, Manejo de ETL (System Integration Services), MS Reporting Services. 
                    <br />
                    *  Experiencia en proyectos manejados con metodología Scrum. Ejecución de Unit Testing.
                    Web Services, WPF, ASP.NET Web App. 
                    <br /> <br />
                    Tener nociones sobre estándares y buenas prácticas en desarrollo e implementaciones.
                    Entendimiento sobre cifrado y estándares utilizados.
                    <br /><br />
                                    
                    <strong>Competencias Humanas:</strong> 
                    <br />
                    * Buen manejo de Lenguaje en general. <br />
                    * Buen manejo de Respuestas directas y Autodidacta. <br />
                    * Dispuesto a aprender nuevas tecnologías. <br />
                    * Trabajo en equipos distribuidos, importante la comunicación y lo Proactivo. <br />
				</p>
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Cuidad de Panamá, Panamá</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>$1,500 - $2,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 1 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
