		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-03.png" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Conductor de Almacén</h3> <!--Aqui va el titulo del empleo-->
							<h5>MiBus</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">MiBus</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$800 - $2,000</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p> Realizar la distribución de mercancía a los diferentes patios con el fin de mantener la disponibilidad de los repuestos en los diferentes almacenes </p>
          ...
          * Bachiller completo.
            <br>
          * Licencia vigente tipo F.
            <br>
          * Conocimiento de Buenas Prácticas de Almacenamiento.
            <br>
          * Mínimo (6) seis meses de experiencia posiciones como conductor, despachador de mercancía, ayudante de bodega, asistente de almacén, ayudante general.
 <br /> <br />
						...
						<div class="job-overview-inner">
							<ul>
								...
								<li>
									...
									<span>Salario</span>
									<h5>$800 - $2,000</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 3 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
