<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="login.aspx.vb" Inherits="JobHire.login" %>
                ...
                <div class="container">
                    ...
                    <div class="right-side">
                        ...
                        <div class="header-widget">
                            <a href="#" class="log-in-button"><i class="icon-feather-log-in"></i> <span> Iniciar sesión / Registrarse</span></a>
                        </div>
		...
		<div class="col-xl-5 offset-xl-3">
			...
			<div class="login-register-page">
				...
				<div class="welcome-text">
					...
					<span>¿No tienes una cuenta? <a href="register.aspx">¡Regístrate!</a></span>
				</div>
					
				<!-- Form -->
					<div class="input-with-icon-left">
						<i class="icon-material-baseline-mail-outline"></i>
                        <asp:TextBox ID="emailaddress" runat="server" class="input-text with-border" type="email" placeholder="Dirección de correo"></asp:TextBox>

					</div>

					<div class="input-with-icon-left">
						<i class="icon-material-outline-lock"></i>
                        <asp:TextBox ID="password" runat="server" class="input-text with-border" type="password" placeholder="Contraseña"></asp:TextBox>                        
					</div>
					<a href="#" class="forgot-password">¿Se te olvidó tu contraseña?</a>
								
				<!-- Button -->
                <asp:Button ID="Button2" runat="server" Text="Iniciar sesión" class="button full-width button-sliding-icon ripple-effect margin-top-10"/> 
