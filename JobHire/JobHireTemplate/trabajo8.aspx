		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-08.jpeg" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>TEC. ELECTROMECÁNICO</h3> <!--Aqui va el titulo del empleo-->
							<h5>GRUPO MELO</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">GRUPO MELO</a></li><!--Aqui va el nombre de la empresa-->
					...
					<div class="right-side">
						<div class="salary-box">
							...
							<div class="salary-amount">$700 - $1,500</div><!--Aqui va el salario random-->
						</div>
					</div>
				</div>
			</div>
	...
	<div class="row">
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p> Realizar labores generales de mantenimiento, reparación instalación de equipos en todas las instalaciones de la Planta de Produccion en Linea, aportar sugerencias que sirvan de soporte para el mejoramiento y funcionamiento en beneficio de la Empresa . </p>
				...
				<p>
                    ...
                    - Experiencia en Mantenimiento Preventivo y correctivo (2 años)
                    <br />
                    - Escolaridad: Tecnico en Electromecanica, Mecanica Industrial
                    <br />
						...
						<div class="job-overview-inner">
							<ul>
								<li>
									...
									<span>Ubicación</span>
									<h5>Juan Díaz, Panamá</h5> <!--Aqui va la ubicacion de la empresa  o negocio-->
								</li>
								<li>
								...
								<li>
									...
									<span>Salario</span>
									<h5>700 - $1,500</h5> <!--Aqui va el salario-->
								</li>
								<li>
									<i class="icon-material-outline-access-time"></i>
									<span>Fecha de publicación</span>
									<h5>hace 10 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
