		...
		<div class="row">
			<div class="col-md-12">
				<div class="single-page-header-inner">
					<div class="left-side">
						<div class="header-image"><a href="alljobs.aspx"><img src="images/company-logo-09.jpeg" alt=""></a></div> <!--Aqui va la imagen de la empresa  o negocio-->
						<div class="header-details">
							<h3>Auxiliar de Farmacia</h3> <!--Aqui va el titulo del empleo-->
							<h5>Farmacia el Jabillo</h5><!--Aqui va el nombre de la empresa-->
							<ul>
								<li><a href="#">Farmacia el Jabillo</a></li><!--Aqui va el nombre de la empresa-->
		...
		<div class="col-xl-8 col-lg-8 content-right-offset">
			...
			<div class="single-page-section">
				...
				<p>
                    ...
                    <br />
                      <br />Cursando estudios de Licenciatura o tecnico en farmacia (1er o 2do año), Mañana o Tarde.
                     <br /> Mayor de edad.
                     <br /> Buenos deseos de laborar y aprender.
                    <br />  Responsable, Puntual.
				</p>
						...
						<div class="job-overview-inner">
							<ul>
								...
								<li>
									...
									<h5>hace 12 días</h5> <!--Aqui va la fecha de la publicacion-->
								</li>
							</ul>
						</div>
					</div>
